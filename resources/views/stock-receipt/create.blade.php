    ...
    <div id="multistepForm">
        ...
        <div id="step1" style="display: block;">
            ...
            <form class="mt-10 max-w-7xl mx-auto" id="formStep1">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label for="refrence_document_no" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Refrence Document No.<span class="text-red-500">*</span></label>
        ...
        <div id="step2" style="display: none;">
            ...
            <form action="{{ route('stock-receipt.store') }}" method="POST" class="mt-10 max-w-7xl mx-auto" id="formStep2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                        <label for="item_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Item Name<span class="text-red-500">*</span></label>
